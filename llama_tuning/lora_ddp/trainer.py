...
class Trainer:
    ...
    def get_data_loader(self):
        ...
        train_data_loader = DataLoader(train_data_set, batch_size=self.batch_size, num_workers=6,
                                       batch_sampler=train_batch_sampler, collate_fn=collate_fn)
        valid_data_loader = DataLoader(valid_data_set, batch_size=self.batch_size, num_workers=6, sampler=valid_sampler,
    ...
    def eval(self):
        ...
        with torch.no_grad():
            ...
            for batch_data in self.valid_data_loader:
                ...
                gather_masks = [torch.zeros_like(attention_mask, dtype=attention_mask.dtype) for _ in
                                range(Config.world_size)]
...
if __name__ == "__main__":
    ...
    trainer.train()
    # mp.spawn(trainer.train(), args=(), nprocs=Config.world_size, join=True)
    cleanup()
...
class Trainer:
    def __init__(self):
        ...
        print("accelerator model load done")
        ...
        self.optimizer, self.train_data_loader, self.valid_data_loader, self.scheduler = self.accelerator.prepare(
            self.optimizer, self.train_data_loader, self.valid_data_loader, self.scheduler
        )

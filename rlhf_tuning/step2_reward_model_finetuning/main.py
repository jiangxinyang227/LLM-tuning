...
from utils.data.data_utils import create_prompt_dataset_custom, DataCollatorReward
...
def main():
    ...
    train_phase = 2
    train_dataset, eval_dataset = create_prompt_dataset_custom(
        args.local_rank,
        train_phase,
        tokenizer,
        args.max_seq_len)

    # DataLoaders creation: 将正负样本concat到一起，即[d1_p, d2_p,..., d1_n, d2_n, ...]这种格式
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            clip_grad_norm_(rm_model.parameters(), 1.0)
            rm_model.step()
            mean_loss += loss.item()
        print_rank_0(
        ...
        if args.output_dir is not None:
            ...
            save_path = args.output_dir + "/" + str(epoch)

...
from utils.data.data_utils import create_prompt_dataset_custom, MiniDataset, DataCollatorRLHF
from utils.utils import print_rank_0, to_device, save_hf_format, set_random_seed, get_all_reduce_mean, moving_average, \
...
def main():
    ...
    train_phase = 3
    prompt_train_dataset, eval_dataset = create_prompt_dataset_custom(
        args.local_rank,
        train_phase,
        tokenizer,
    ...
    for epoch in range(args.num_train_epochs):
        ...
        for step, batch_prompt in enumerate(prompt_train_dataloader):
            ...
            if exp_dataset is not None:
                ...
                print_rank_0(
                    f'epoch: {epoch}|step: {step}|ppo_ep: {ppo_ep + 1}|act_loss: {actor_loss_sum / inner_iter}|cri_loss: {critic_loss_sum / inner_iter}',
                    args.global_rank)
